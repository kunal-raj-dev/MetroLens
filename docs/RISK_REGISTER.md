# RISK REGISTER & 48-HOUR KILL-SWITCH PROTOCOL (V0.2)
...
| **R-05** | **Outdated Legal Claims Challenged:** Jury challenges obsolete Section 36 penalty claims or asks about Form A. | Legal & Domain | 5 | 2 | **10** | Presenter mentions "automatic fines" or "Form A". | Fully align documents and report templates with Jan Vishwas Act 2023 Improvement Notice mechanism; remove Form A. | Presenter correctly cites Section 36(1) Improvement Notice and Section 15 prima facie screening. | Member 6 | Day 1 (T+16h) |
