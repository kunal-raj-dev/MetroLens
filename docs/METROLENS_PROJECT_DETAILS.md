...
| 🔴 **Red** | `POTENTIAL_NON_COMPLIANCE` | Clear legal defect: Missing mandatory item (e.g. no consumer care email), font height $<0.10\text{mm}$ below statutory minimum, or USP math mismatch $>1\%$. | **Issue Section 36(1) Improvement Notice** (under Jan Vishwas Act, 2026) specifying reasonable cure period (15 days demonstration default). |
