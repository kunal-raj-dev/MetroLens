...
| [`docs/MVP_UNIFIED_WORKFLOW_GRAPH.md`](docs/MVP_UNIFIED_WORKFLOW_GRAPH.md) | **Technical Architecture** | Master 16-node unified MVP workflow graph, data contracts, failure fallback policies, and M1–M6 team ownership matrix. |
