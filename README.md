...
| [`docs/METROLENS_PROJECT_DETAILS.md`](docs/METROLENS_PROJECT_DETAILS.md) | **Platform Master Guide** | Comprehensive end-to-end guide: statutory context, 5-step user journey, real-world defect scenarios, 5-layer failovers, and competition demonstration script. |
